...
const avoidList = [
	...
	'Painful leadership transitions, terminations & under-performance',
	'Unstable work environments & unhealthy staff culture',
...
export default function SaveComponent( { attributes } ) {
	...
	return (
		<section className="stakes">
			<div className="stakes__background clip-color-left">
				<div className="stakes__background--color" />
				{ hasBackgroundImage && (
					<>
						<div
							className="stakes__background--lower"
							style={ {
								backgroundImage: `url(${ backgroundImage })`,
							} }
						/>
						<div className="stakes__background--upper" />
					</>
				) }
			</div>
			<div className="stakes__content py-5">
				<div className="container">
					<div className="row mb-5">
						<div className="col d-flex flex-column text-center text-white">
							<h2
								className="headline"
							...
							{ subheadline && (
								<div
									className="subheadline mt-3 mb-5"
					...
					<div className="stakes__content--background row mb-5">
						<div className="row align-items-stretch">
							<div className="col col-lg-6">
								<div className="swiper" id="stakes">
									<div className="swiper-pagination swiper-stakes-pagination"></div>
									<div className="swiper-wrapper">
										<div className="swiper-slide d-flex flex-column align-items-center">
											<h3 className="display-3 w-75 text-center">
											...
											<div className="borders row w-100 gap-2">
												<hr className="col-1 border-5 border-primary" />
												<hr className="col-6 border-5 flex-grow-1" />
												<hr className="col-1 border-5 border-primary" />
											</div>
											<ul className="fw-bold mb-2">
												{ avoidList.map(
													( list_item ) => (
														<li>{ list_item }</li>
													)
										...
										<div className="swiper-slide d-flex flex-column align-items-center">
											...
											<ul className="list-unstyled d-flex flex-column align-items-center m-0 mb-5 mb-lg-0 text-center gap-3">
												<li>
													<svg
														className="stakes__icon"
														id="community"
														viewBox="0 0 113.813 68.18"
													>
														<defs>
