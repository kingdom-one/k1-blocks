 ...
 * 
 * @param string $leaf the leaf variant to return 
 * @param string $color the leaf color
 * @param string $direction the direction of the leaves
 * @return string the markup
*/
function k1_get_the_leaf( int $leaf, string $color = 'white', string $direction = 'left' ):string {
	$scale = ( 'left' === $direction ) ? 1 : -1;
	$markup = "<div class='k1_leaf__container' id='leaves-{$leaf}' style='color:{$color};scaleX:{$scale}>";
	switch($leaf) {
		case 2:
